        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Manage and track your incident reports and their completion status.
            </p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              View and manage all your incident reports. Showing {filteredReports.length} of {reports.length} reports.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* Filters */}
                      ...
                      <TableRow key={report.id} className="hover:bg-muted/30 transition-colors">
                        <TableCell>
                          <div className="max-w-[200px]">
                            ...
                            {report.content?.incidentDetails?.incidentLocation && (
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end space-x-2">
                            ...
                            {report.status?.toLowerCase() !== 'approved' && (
                              <Button size="sm" variant="outline" asChild>
                                <Link href={`/dashboard/traffic/reports/${report.id}?mode=edit`}>
